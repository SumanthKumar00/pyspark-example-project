...
This project is currently maintained by Sumanth Kumar Sivadi.

Sumanth is a Data Engineer with 3+ years of experience specializing in the design and development of scalable data pipelines, ETL/ELT processes, and cloud-based data platforms. He is highly proficient in Python, SQL, and PySpark, with hands-on experience across various cloud and data warehousing solutions. His expertise includes data modeling, data quality validation, and performance optimization to deliver reliable, production-ready data solutions.

-   **Email**: sumanthkumar.sivadi@gmail.com